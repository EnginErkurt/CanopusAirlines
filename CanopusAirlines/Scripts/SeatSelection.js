document.addEventListener('DOMContentLoaded', () => {
    ...
    // Generate Grid Logic (3-3-3 Layout: ABC - DEF - GHJ)
    // Note: Standard widebody usually excludes 'I' to avoid confusion with '1'.
    ...
    // Event Delegation for Seat Interaction
    cabinGrid.addEventListener('mouseover', (e) => {
        ...
        if (seat && !seat.classList.contains('occupied')) {
            ...
            tooltip.style.top = `${rect.top - 60}px`; // Place above seat
